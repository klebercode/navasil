...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'People.marital'
        db.add_column(u'core_people', 'marital',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'People.marital'
        db.delete_column(u'core_people', 'marital')
    ...
    models = {
        ...
        u'core.people': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Job']", 'null': 'True', 'blank': 'True'}),
            'marital': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
