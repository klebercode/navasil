...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_people', 'email')

        # Deleting field 'People.phone_fix'
        db.delete_column(u'core_people', 'phone_fix')

        # Deleting field 'People.phone_mobile_2'
        db.delete_column(u'core_people', 'phone_mobile_2')

        # Deleting field 'People.phone_mobile'
        db.delete_column(u'core_people', 'phone_mobile')


    def backwards(self, orm):
        # Adding field 'People.email'
        db.add_column(u'core_people', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'People.phone_fix'
        db.add_column(u'core_people', 'phone_fix',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'People.phone_mobile_2'
        db.add_column(u'core_people', 'phone_mobile_2',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'People.phone_mobile'
        db.add_column(u'core_people', 'phone_mobile',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)
