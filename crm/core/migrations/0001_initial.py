...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #     ('cpnj', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
    ...
    models = {
        ...
        u'core.contactemail': {
            'Meta': {'ordering': "['name', 'email']", 'object_name': 'ContactEmail'},
        ...
        u'core.contactphone': {
            'Meta': {'ordering': "['name', 'number']", 'object_name': 'ContactPhone'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Customer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
